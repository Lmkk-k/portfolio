...
const projects = [
  {
    ...
    technologies: ["ASP.NET Core MVC", "C#", "SQL Server", "Entity Framework", "Razor Pages", "JavaScript",],
    features: [
    ...
    demoUrl: "https://github.com/Lmkk-k/FINALHOTEL-MANAGEMENT",
    githubUrl: "https://github.com/Lmkk-k/FINALHOTEL-MANAGEMENT",
  ...
  },
  {
    ...
    longDescription: "My thesis project: A gamified mobile application designed to educate users about traffic rules and jeepney routes in Cebu City. The app combines interactive quizzes, mini-games, and real-world traffic simulations to make learning engaging. Features map-based logic inspired by GIS concepts, 3D vehicle models, and progressive difficulty levels to enhance user learning experience.",
    technologies: ["Godot Engine", "GDScript", "Blender", "Android SDK", "GIS Concepts", "Game Design"],
    features: [
      "Interactive traffic rule quizzes",
    ...
    githubUrl: "https://github.com/Lmkk-k",
  ...
  },
  {
    ...
    longDescription: "A functional online store with product browsing, shopping cart functionality, and checkout process. Built with a clean interface for easy shopping experience.",
  ...
  },
  {
    ...
    longDescription: "A productivity application designed for teams to manage projects and tasks efficiently. Features include task assignment, deadline tracking, team collaboration",
    ...
    longDescription: "A clean note-taking application that allows users to create, edit, and delete notes. Notes are saved in the browser's local storage, so they persist between sessions. Features a minimalist design for distraction-free writing.",
